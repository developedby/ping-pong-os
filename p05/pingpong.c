...
void pingpong_init ()
{
  ...
  preemption_timer.it_value.tv_usec = 4000 ;      // primeiro disparo, em micro-segundos
  preemption_timer.it_value.tv_sec  = 0 ;      // primeiro disparo, em segundos
  preemption_timer.it_interval.tv_usec = 1000 ;   // disparos subsequentes, em micro-segundos
